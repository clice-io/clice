...
public:
    ...
    /// requests (worker::ScopeParams, worker::ClaimParams), on the event
    /// loop. A worker asks only under a plan that claims; the consumer of
    /// such plans installs both before its first run.
