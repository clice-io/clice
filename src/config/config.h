...
struct ConfigRule {
    ...
    KOTATSU_ANNOTATE(defaulted = true,
                     description =
                         ...
                         "keeps them out: their declarations are neither "
                         "checked nor reported, and a translation unit they "
                         "head is not parsed. Files outside the workspace are "
                         "never checked. Any matching rule saying `false` wins.")
    <bool> lint = true;
