...
/// indexing. Results are sorted before rendering — reply order leaks
/// container iteration order and the server caps result counts, so
/// fixtures must stay small enough that no query ever hits the cap.
